...
urlpatterns = [
    ...
    path(r'companies/', CompanyListView.as_view(), name='company-list'),
    path(r'companies/<int:pk>/', CompanyDetailView.as_view(), name='company-detail'),
    path(r'companies/<int:pk>/records/', CompanyRecordListView.as_view(), name='company-record-list'),

    path(r'import/records/', views.LogImportRecordsView.as_view(), name='import-records'),
    path(r'import/artists/', views.LogImportArtistsView.as_view(), name='import-artists'),
]
